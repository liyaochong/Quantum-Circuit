...
def Opt_iswap_deltat(deltat):
    ...
    if quset.qtype == 1:
        ...
        psi0 = tensor(basis(quset.N,n) , basis(3,1) ,  basis(3,0))#初态
        target = tensor(basis(quset.N,n) , basis(3,0) ,  basis(3,1))#目标状态
        ...
        U = tensor(qeye(quset.N),rf0,rf1)#旋转坐标系
