...
def cy_td_ode_rhs(
    ...
    spmvpy(data1, idx1, ptr1, vec, (w_t0)*(0<t<=600), out)
    spmvpy(data2, idx2, ptr2, vec, (w_t1)*(0<t<=600), out)
    spmvpy(data3, idx3, ptr3, vec, 0*(0<t<=600), out)
    spmvpy(data4, idx4, ptr4, vec, 0*(0<t<=600), out)
    return out
